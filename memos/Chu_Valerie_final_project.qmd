...
Still, the random forest model built with the kitchen sink had the lowest RMSE and lowest standard error of all the models, so it is the best model. It's predictions will be closest to the true values.
