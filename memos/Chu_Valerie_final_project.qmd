...
- I filtered out variables with zero variance. 

- Then I centered and scaled all predictors. 


I decided on my feature engineered recipes based on my exploratory data analysis of the target variable, average price, and other variables in the dataset. See Appendix B for more information.
